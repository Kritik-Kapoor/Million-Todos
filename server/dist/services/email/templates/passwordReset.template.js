import { APP_NAME, buildAppUrl, buildEmailShell, buildFallbackLink, buildPrimaryButton, escapeHtml, } from "./email.shared.js";
export function buildPasswordResetEmailTemplate(username, passwordResetToken) {
    ...
    <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #4b5563;">
      If you made this request, use the button below to choose a new password. This link will expire in <strong style="color: #111827;">15 minutes</strong>.
    </p>
    <p style="margin: 0 0 12px 0; font-size: 15px; line-height: 1.6; color: #4b5563;">
