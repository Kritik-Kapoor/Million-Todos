import { APP_NAME, buildAppUrl, buildEmailShell, buildPrimaryButton, escapeHtml, } from "./email.shared.js";
...
export function buildDueReminderTemplate(username, todos, totalTodosDueIn6Hours) {
    ...
    const subject = totalTodosDueIn6Hours === 1
  ...
  `;
    const html = buildEmailShell({
        ...
        body,
        footer: "You are receiving this because due date reminders are enabled for your account.",
    });
    return { subject, html };
}
