...
import { deleteAccount, forgotPassword, getUser, Login, Logout, Register, resetPassword, sendVerificationMail, updateUser, updateUserPreferences, verifyAccount, } from "../controllers/auth.controller.js";
...
router.post("/send-verification-mail", authenticateUser, authRateLimiter, sendVerificationMail);
